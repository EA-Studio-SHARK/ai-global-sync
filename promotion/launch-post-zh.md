...
- 安装与运行：
  ...
  - 或直接 `npx ai-global-sync global.md`
...
2. 运行 `npx ai-global-sync global.md`。
3. 展示工具配置路径：`~/.claude/CLAUDE.md`、`~/.cursor/rules/global.md`、`~/.codex/AGENTS.md`、`~/.windsurf/rules.md` 内容已同步一致。
